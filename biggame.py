...
def backend():
  ...
  query = f"Select * from Shops inner join Location on Shops.id_shop = Location.id_shops inner join Games on Location.id_games = Games.id_games WHERE Shops.indirizzo_shop = '{via_negozio}' and Shops.citta_negozio = '{citta_negozio}'"
